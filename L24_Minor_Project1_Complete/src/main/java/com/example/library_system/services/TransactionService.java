...
public class TransactionService {
    ...
    public Integer initiateTxn(CreateTxnRequest createTxnRequest) throws BadRequestException {
    ...
    private Integer initiateIssueTxn(CreateTxnRequest createTxnRequest, Pair bookStudentPair) throws BadRequestException {
        ...
        if(issuedBooks != null && issuedBooks.size() >= maxAllowedBooksForIssuance){
        ...
        this.transactionRepository.save(transaction); // created_on
...
//        this.bookService.createBook(book);
            ...
            // upsert
            this.transactionRepository.save(transaction); // Since the entity is already present, hibernate will do update and not insert
        }catch (Exception e){
            e.printStackTrace();
    ...
    private Integer initiateReturnTxn(CreateTxnRequest createTxnRequest, Pair bookStudentPair) throws BadRequestException {
