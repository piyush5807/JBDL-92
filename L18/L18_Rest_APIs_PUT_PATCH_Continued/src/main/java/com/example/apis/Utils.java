...
//    @Bean
    ...
    public Employee convertToEmployee(EmployeeRequest employeeRequest, String employeeId, Employee employee, boolean isUpdate){
        if(employee == null){
            return convertToEmployee(employeeRequest, employeeId, isUpdate);
        }
